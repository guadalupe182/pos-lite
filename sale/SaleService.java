...
public class SaleService {
    ...
    public Sale registerSale(SaleRequest request, String userEmail) {
        ...
        // Validar caja activa
        if (!cashSessionService.getCurrentSessionDto().getStatus().equals("ACTIVE")) {
            throw new IllegalStateException("La sesión de caja no está activa. No se puede procesar la venta.");
        }
